...
type ExampleServiceClient interface {
	TestValidate(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Respone, error)
}
...
func (c *exampleServiceClient) TestValidate(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Respone, error) {
	out := new(Respone)
...
func (UnimplementedExampleServiceServer) TestValidate(context.Context, *Request) (*Respone, error) {
...
var ExampleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "validate/api/example.proto",
}
